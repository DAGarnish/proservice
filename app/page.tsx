        ...
        <div className={styles.heroContent}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', backgroundColor: 'var(--color-white)', padding: 'var(--space-4) var(--space-6)', borderRadius: 'var(--radius-full)', boxShadow: 'var(--shadow-md)', border: '1px solid var(--color-gray-200)', marginTop: 'calc(var(--space-6) + 30px)', width: 'fit-content' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--color-gray-700)', margin: 0, lineHeight: 1.4 }}>
              <strong>Hi, I'm Dave, your account manager.</strong><br />I will be guiding you through the process, so <a href="#verify-email-form" style={{ textDecoration: 'underline', color: 'inherit' }}>send me a message</a>,<br />
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                or you can send me a text via
                <a href="https://wa.me/14242848886" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', color: '#25D366', textDecoration: 'none', fontWeight: 600 }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{ marginRight: '2px' }}>
